...
class ExampleUnitTest {
    ...
    @Test
    fun workdaysInMonth_marchTwentyfour() {
        val year = 2024
        val month = 3
        val expectedNumberOfWorkdays = 21
        val actualNumberOfWorkdays = workdaysInMonth(year, month)
        assertEquals(expectedNumberOfWorkdays, actualNumberOfWorkdays)
    }

    @Test
    fun workdaysInMonth_octoberTwentythree() {
        val year = 2023
        val month = 10
        val expectedNumberOfWorkdays = 22
        val actualNumberOfWorkdays = workdaysInMonth(year, month)
        assertEquals(expectedNumberOfWorkdays, actualNumberOfWorkdays)
    }
}